...
#define Counter_1_INIT_PERIOD_VALUE       999u
#define Counter_1_INIT_COUNTER_VALUE      999u
#if (Counter_1_UsingFixedFunction)
#define Counter_1_INIT_INTERRUPTS_MASK    ((uint8)((uint8)1u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_1_INIT_COMPARE_VALUE      1u
#define Counter_1_INIT_INTERRUPTS_MASK ((uint8)((uint8)1u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
