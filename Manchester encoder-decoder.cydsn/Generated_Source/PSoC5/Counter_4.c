                                   ...
                                   
{
        ...
        Counter_4_GLOBAL_ENABLE &= ((uint8)(~Counter_4_BLOCK_EN_MASK));
    #else
        CY_SET_REG16(Counter_4_COUNTER_LSB_PTR, counter);
    #endif /* (Counter_4_UsingFixedFunction) */
}
#endif /* (!(Counter_4_UsingFixedFunction && (CY_PSOC5A))) */
...
uint16 Counter_4_ReadCounter(void) 
{
    ...
    #if(Counter_4_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(Counter_4_STATICCOUNT_LSB_PTR));
    #else
        return (CY_GET_REG16(Counter_4_STATICCOUNT_LSB_PTR));
    #endif /* (Counter_4_UsingFixedFunction) */
}
...
void Counter_4_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(Counter_4_PERIOD_LSB_PTR, period);
    #endif /* (Counter_4_UsingFixedFunction) */
}
...
{
    #if(Counter_4_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(Counter_4_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(Counter_4_PERIOD_LSB_PTR));
    #endif /* (Counter_4_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG16(Counter_4_COMPARE_LSB_PTR, compare);
    #endif /* (Counter_4_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG16(Counter_4_COMPARE_LSB_PTR));
}
