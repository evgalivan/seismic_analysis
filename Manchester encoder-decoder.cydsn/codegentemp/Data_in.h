...
void    Data_in_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Data_in_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Data_in__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Data_in_SetInterruptMode() function.
     *  @{
     */
        #define Data_in_INTR_NONE      (uint16)(0x0000u)
        #define Data_in_INTR_RISING    (uint16)(0x0001u)
        #define Data_in_INTR_FALLING   (uint16)(0x0002u)
        #define Data_in_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Data_in_INTR_MASK      (0x01u) 
#endif /* (Data_in__INTSTAT) */
...
/* SIO registers */
#if defined(Data_in__SIO_CFG)
    #define Data_in_SIO_HYST_EN        (* (reg8 *) Data_in__SIO_HYST_EN)
    #define Data_in_SIO_REG_HIFREQ     (* (reg8 *) Data_in__SIO_REG_HIFREQ)
    #define Data_in_SIO_CFG            (* (reg8 *) Data_in__SIO_CFG)
    #define Data_in_SIO_DIFF           (* (reg8 *) Data_in__SIO_DIFF)
#endif /* (Data_in__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Data_in_0_INTTYPE_REG 		(* (reg8 *) Data_in__0__INTTYPE)
#endif /* (Data_in__INTSTAT) */
