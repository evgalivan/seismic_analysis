...
/* Error message for removed Counter_2_CounterUDB_sCTRLReg_ctrlreg through optimization */
#ifdef Counter_2_CounterUDB_sCTRLReg_ctrlreg__REMOVED
    #error Counter_v3_0 detected with a constant 0 for the enable, a \
                                constant 0 for the count or constant 1 for \
                                the reset. This will prevent the component from\
                                operating.
#endif /* Counter_2_CounterUDB_sCTRLReg_ctrlreg__REMOVED */
...
#define Counter_2_GetInterruptSource() Counter_2_ReadStatusRegister()
#if(!Counter_2_ControlRegRemoved)
...
#define Counter_2_CMP_MODE_LT 1u
#define Counter_2_CMP_MODE_LTE 2u
#define Counter_2_CMP_MODE_EQ 0u
#define Counter_2_CMP_MODE_GT 3u
#define Counter_2_CMP_MODE_GTE 4u
#define Counter_2_CMP_MODE_SOFTWARE_CONTROLLED 5u
...
/* Enumerated Type Counter_CompareModes */
#define Counter_2_CAP_MODE_NONE 0u
#define Counter_2_CAP_MODE_RISE 1u
#define Counter_2_CAP_MODE_FALL 2u
#define Counter_2_CAP_MODE_BOTH 3u
#define Counter_2_CAP_MODE_SOFTWARE_CONTROLLED 4u


/***************************************
 *  Initialization Values
 **************************************/
#define Counter_2_CAPTURE_MODE_CONF       0u
#define Counter_2_INIT_PERIOD_VALUE       31u
#define Counter_2_INIT_COUNTER_VALUE      0u
#if (Counter_2_UsingFixedFunction)
#define Counter_2_INIT_INTERRUPTS_MASK    ((uint8)((uint8)0u << Counter_2_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_2_INIT_COMPARE_VALUE      3u
#define Counter_2_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_2_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)0u << Counter_2_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_2_STATUS_CMP_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_2_STATUS_OVERFLOW_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_2_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT)))
#define Counter_2_DEFAULT_COMPARE_MODE    1u

#if( 0 != Counter_2_CAPTURE_MODE_CONF)
    #define Counter_2_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)0u << Counter_2_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_2_DEFAULT_CAPTURE_MODE    (0u )
#endif /* ( 0 != Counter_2_CAPTURE_MODE_CONF) */
 ...
 *************************************/
    ...
    #define Counter_2_RT1                 (*(reg8 *) Counter_2_CounterHW__RT1)
    #define Counter_2_RT1_PTR             ( (reg8 *) Counter_2_CounterHW__RT1)
#else
    
    #if (Counter_2_Resolution <= 8u) /* 8-bit Counter */
    ...
    #elif(Counter_2_Resolution <= 16u) /* 16-bit Counter */
        #if(CY_PSOC3) /* 8-bit address space */ 
            #define Counter_2_STATICCOUNT_LSB     (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__F0_REG )
            #define Counter_2_STATICCOUNT_LSB_PTR ( (reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__F0_REG )
            #define Counter_2_PERIOD_LSB          (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__D0_REG )
            #define Counter_2_PERIOD_LSB_PTR      ( (reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__D0_REG )
            #define Counter_2_COMPARE_LSB         (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__D1_REG )
            #define Counter_2_COMPARE_LSB_PTR     ( (reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__D1_REG )
            #define Counter_2_COUNTER_LSB         (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__A0_REG )  
            #define Counter_2_COUNTER_LSB_PTR     ( (reg16 *)\
                Counter_2_CounterUDB_sC8_counterdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Counter_2_STATICCOUNT_LSB     (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_F0_REG )
            #define Counter_2_STATICCOUNT_LSB_PTR ( (reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_F0_REG )
            #define Counter_2_PERIOD_LSB          (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_D0_REG )
            #define Counter_2_PERIOD_LSB_PTR      ( (reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_D0_REG )
            #define Counter_2_COMPARE_LSB         (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_D1_REG )
            #define Counter_2_COMPARE_LSB_PTR     ( (reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_D1_REG )
            #define Counter_2_COUNTER_LSB         (*(reg16 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_A0_REG )  
            #define Counter_2_COUNTER_LSB_PTR     ( (reg16 *)\
                Counter_2_CounterUDB_sC8_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
    #elif(Counter_2_Resolution <= 24u) /* 24-bit Counter */
        
        #define Counter_2_STATICCOUNT_LSB     (*(reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__F0_REG )
        #define Counter_2_STATICCOUNT_LSB_PTR ( (reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__F0_REG )
        #define Counter_2_PERIOD_LSB          (*(reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__D0_REG )
        #define Counter_2_PERIOD_LSB_PTR      ( (reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__D0_REG )
        #define Counter_2_COMPARE_LSB         (*(reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__D1_REG )
        #define Counter_2_COMPARE_LSB_PTR     ( (reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__D1_REG )
        #define Counter_2_COUNTER_LSB         (*(reg32 *) \
            Counter_2_CounterUDB_sC8_counterdp_u0__A0_REG )  
        #define Counter_2_COUNTER_LSB_PTR     ( (reg32 *)\
            Counter_2_CounterUDB_sC8_counterdp_u0__A0_REG )
            ...
            #define Counter_2_STATICCOUNT_LSB     (*(reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_F0_REG )
            #define Counter_2_STATICCOUNT_LSB_PTR ( (reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_F0_REG )
            #define Counter_2_PERIOD_LSB          (*(reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_D0_REG )
            #define Counter_2_PERIOD_LSB_PTR      ( (reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_D0_REG )
            #define Counter_2_COMPARE_LSB         (*(reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_D1_REG )
            #define Counter_2_COMPARE_LSB_PTR     ( (reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_D1_REG )
            #define Counter_2_COUNTER_LSB         (*(reg32 *) \
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_A0_REG )  
            #define Counter_2_COUNTER_LSB_PTR     ( (reg32 *)\
                Counter_2_CounterUDB_sC8_counterdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */   
    #endif

	#define Counter_2_COUNTER_LSB_PTR_8BIT     ( (reg8 *)\
                Counter_2_CounterUDB_sC8_counterdp_u0__A0_REG )
    ...
    #define Counter_2_AUX_CONTROLDP0_PTR \
       ...
       #define Counter_2_AUX_CONTROLDP1_PTR \
           ( (reg8 *) Counter_2_CounterUDB_sC8_counterdp_u1__DP_AUX_CTL_REG)
    #endif /* (Counter_2_Resolution == 16 || Counter_2_Resolution == 24 || Counter_2_Resolution == 32) */
       ...
       #define Counter_2_AUX_CONTROLDP2_PTR \
           ( (reg8 *) Counter_2_CounterUDB_sC8_counterdp_u2__DP_AUX_CTL_REG)
    #endif /* (Counter_2_Resolution == 24 || Counter_2_Resolution == 32) */
    ...
    ********************************/
    ...
    #define Counter_2_ONESHOT_SHIFT          0x02u
    /* Control Register Bit Masks */
    #define Counter_2_CTRL_ENABLE            ((uint8)((uint8)0x01u << Counter_2_CTRL_ENABLE_SHIFT))         
    #define Counter_2_ONESHOT                ((uint8)((uint8)0x01u << Counter_2_ONESHOT_SHIFT))
    ...
    /* Set the mask for run mode */
        ...
        #define Counter_2_CTRL_MODE_MASK         ((uint8)((uint8)0x07u << Counter_2_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC5A) */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Use CFG2 Mode bits to set run mode */
        #define Counter_2_CTRL_MODE_SHIFT        0x00u    
        #define Counter_2_CTRL_MODE_MASK         ((uint8)((uint8)0x03u << Counter_2_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC3 || CY_PSOC5LP) */
    /* Set the mask for interrupt (raw/status register) */
    #define Counter_2_CTRL2_IRQ_SEL_SHIFT     0x00u
    #define Counter_2_CTRL2_IRQ_SEL          ((uint8)((uint8)0x01u << Counter_2_CTRL2_IRQ_SEL_SHIFT))     
    ...
    #define Counter_2_STATUS_ZERO            ((uint8)((uint8)0x01u << Counter_2_STATUS_ZERO_SHIFT))

    /* Status Register Interrupt Bit Masks*/
    #define Counter_2_STATUS_ZERO_INT_EN_MASK       ((uint8)((uint8)Counter_2_STATUS_ZERO >> 0x04u))
    
    /*RT1 Synch Constants: Applicable for PSoC3 and PSoC5LP */
    #define Counter_2_RT1_SHIFT            0x04u
    #define Counter_2_RT1_MASK             ((uint8)((uint8)0x03u << Counter_2_RT1_SHIFT))  /* Sync TC and CMP bit masks */
    #define Counter_2_SYNC                 ((uint8)((uint8)0x03u << Counter_2_RT1_SHIFT))
    #define Counter_2_SYNCDSI_SHIFT        0x00u
    #define Counter_2_SYNCDSI_MASK         ((uint8)((uint8)0x0Fu << Counter_2_SYNCDSI_SHIFT)) /* Sync all DSI inputs */
    #define Counter_2_SYNCDSI_EN           ((uint8)((uint8)0x0Fu << Counter_2_SYNCDSI_SHIFT)) /* Sync all DSI inputs */
    
#else /* !Counter_2_UsingFixedFunction */
    #define Counter_2_STATUS               (* (reg8 *) Counter_2_CounterUDB_sSTSReg_stsreg__STATUS_REG )
    #define Counter_2_STATUS_PTR           (  (reg8 *) Counter_2_CounterUDB_sSTSReg_stsreg__STATUS_REG )
    #define Counter_2_STATUS_MASK          (* (reg8 *) Counter_2_CounterUDB_sSTSReg_stsreg__MASK_REG )
    #define Counter_2_STATUS_MASK_PTR      (  (reg8 *) Counter_2_CounterUDB_sSTSReg_stsreg__MASK_REG )
    #define Counter_2_STATUS_AUX_CTRL      (*(reg8 *) Counter_2_CounterUDB_sSTSReg_stsreg__STATUS_AUX_CTL_REG)
    #define Counter_2_STATUS_AUX_CTRL_PTR  ( (reg8 *) Counter_2_CounterUDB_sSTSReg_stsreg__STATUS_AUX_CTL_REG)
    ...
    ********************************/
    ...
    /* Control Register Bit Masks */
    #define Counter_2_CTRL_CMPMODE_MASK      0x07u 
    #define Counter_2_CTRL_CAPMODE_MASK      0x03u  
    #define Counter_2_CTRL_RESET             ((uint8)((uint8)0x01u << Counter_2_CTRL_RESET_SHIFT))  
    #define Counter_2_CTRL_ENABLE            ((uint8)((uint8)0x01u << Counter_2_CTRL_ENABLE_SHIFT)) 
    ...
    /* Status Register Bit Masks */                
    #define Counter_2_STATUS_CMP             ((uint8)((uint8)0x01u << Counter_2_STATUS_CMP_SHIFT))  
    #define Counter_2_STATUS_ZERO            ((uint8)((uint8)0x01u << Counter_2_STATUS_ZERO_SHIFT)) 
    #define Counter_2_STATUS_OVERFLOW        ((uint8)((uint8)0x01u << Counter_2_STATUS_OVERFLOW_SHIFT)) 
    #define Counter_2_STATUS_UNDERFLOW       ((uint8)((uint8)0x01u << Counter_2_STATUS_UNDERFLOW_SHIFT)) 
    #define Counter_2_STATUS_CAPTURE         ((uint8)((uint8)0x01u << Counter_2_STATUS_CAPTURE_SHIFT)) 
    #define Counter_2_STATUS_FIFOFULL        ((uint8)((uint8)0x01u << Counter_2_STATUS_FIFOFULL_SHIFT))
    #define Counter_2_STATUS_FIFONEMP        ((uint8)((uint8)0x01u << Counter_2_STATUS_FIFONEMP_SHIFT))
