...
{
    uint8 staticBits = (DIN_DR & (uint8)(~DIN_MASK));
    DIN_DR = staticBits | ((uint8)(value << DIN_SHIFT) & DIN_MASK);
}
...
{
	CyPins_SetPinDriveMode(DIN_0, mode);
}
...
uint8 DIN_Read(void)
{
    return (DIN_PS & DIN_MASK) >> DIN_SHIFT;
}
...
{
    return (DIN_DR & DIN_MASK) >> DIN_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(DIN_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & DIN_0_INTR) != 0u) 
		{ 
			 DIN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (DIN_INTSTAT & DIN_MASK) >> DIN_SHIFT;
    }
