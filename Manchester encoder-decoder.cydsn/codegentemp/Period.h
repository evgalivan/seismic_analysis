...
#define Period_SR_MASK    (0xFFFFFFFFu) /* Unsigned is added to parameter */
...
#define Period_SHIFT_REG_CAPTURE_PTR    ( (reg8 *) \
    ...
    #define Period_OUT_FIFO_VAL_LSB_PTR       ( (reg32 *) \
        ...
        #define Period_IN_FIFO_VAL_LSB_PTR        ( (reg16 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__16BIT_F0_REG )

        #define Period_SHIFT_REG_LSB_PTR          ( (reg16 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__16BIT_A0_REG )

        #define Period_SHIFT_REG_VALUE_LSB_PTR    ( (reg16 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__16BIT_A1_REG )

        #define Period_OUT_FIFO_VAL_LSB_PTR       ( (reg16 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__16BIT_F1_REG )
    ...
    #else /* 32bit - ShiftReg */
        #define Period_IN_FIFO_VAL_LSB_PTR        ( (reg32 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__32BIT_F0_REG )

        #define Period_SHIFT_REG_LSB_PTR          ( (reg32 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__32BIT_A0_REG )

        #define Period_SHIFT_REG_VALUE_LSB_PTR    ( (reg32 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__32BIT_A1_REG )

        #define Period_OUT_FIFO_VAL_LSB_PTR       ( (reg32 *) \
                                  Period_bSR_sC32_BShiftRegDp_u0__32BIT_F1_REG )
