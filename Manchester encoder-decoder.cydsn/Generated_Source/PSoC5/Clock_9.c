...
void Clock_9_Start(void) 
{
    ...
    Clock_9_CLKEN |= Clock_9_CLKEN_MASK;
	Clock_9_CLKSTBY |= Clock_9_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clock_9_Stop
********************************************************************************
*
* Summary:
...
void Clock_9_Stop(void) 
{
    ...
    Clock_9_CLKEN &= (uint8)(~Clock_9_CLKEN_MASK);
	Clock_9_CLKSTBY &= (uint8)(~Clock_9_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clock_9_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_StopBlock(void) 
{
    if ((Clock_9_CLKEN & Clock_9_CLKEN_MASK) != 0u)
    {
...
#if defined(Clock_9__CFG3)
        CLK_DIST_AMASK = Clock_9_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_9_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(Clock_9_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_9_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clock_9_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Clock_9_CLKSTBY &= (uint8)(~Clock_9_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Clock_9_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Clock_9_GetSourceRegister();
    uint16 oldDivider = Clock_9_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_9_CLKEN & Clock_9_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clock_9_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clock_9_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Clock_9_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_9_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_SetModeRegister(uint8 modeBitMask) 
{
    Clock_9_MOD_SRC |= modeBitMask & (uint8)Clock_9_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_9_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_ClearModeRegister(uint8 modeBitMask) 
{
    Clock_9_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clock_9_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clock_9_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_9_GetModeRegister(void) 
{
    return Clock_9_MOD_SRC & (uint8)(Clock_9_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clock_9_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Clock_9_GetDividerRegister();
    uint8 oldSrc = Clock_9_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clock_9_MOD_SRC |= CYCLK_SSS;
        Clock_9_MOD_SRC =
            (Clock_9_MOD_SRC & (uint8)(~Clock_9_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_9_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_9_GetSourceRegister(void) 
{
    return Clock_9_MOD_SRC & Clock_9_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_9_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_9_SetPhaseRegister(uint8 clkPhase) 
{
    Clock_9_PHASE = clkPhase & Clock_9_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_9_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_9_GetPhaseRegister(void) 
{
    return Clock_9_PHASE & Clock_9_PHASE_MASK;
}
