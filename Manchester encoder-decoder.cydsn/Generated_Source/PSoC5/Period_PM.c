...
static Period_BACKUP_STRUCT Period_backup =
{
    ...
    ((uint32) Period_DEFAULT_A0),
    ((uint32) Period_DEFAULT_A1),

    #if(CY_UDB_V0)
        ((uint32) Period_INT_SRC),
    #endif /* (CY_UDB_V0) */
};
...
void Period_SaveConfig(void) 
{
    ...
    Period_backup.saveSrA0Reg   = CY_GET_REG32(Period_SHIFT_REG_LSB_PTR);
    Period_backup.saveSrA1Reg   = CY_GET_REG32(Period_SHIFT_REG_VALUE_LSB_PTR);
...
void Period_RestoreConfig(void) 
{
    ...
    CY_SET_REG32(Period_SHIFT_REG_LSB_PTR, Period_backup.saveSrA0Reg);
    CY_SET_REG32(Period_SHIFT_REG_VALUE_LSB_PTR, Period_backup.saveSrA1Reg);
