...
*
* \funcusage
*  \snippet DOUT_SUT.c usage_DOUT_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet DOUT_SUT.c usage_DOUT_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet DOUT_SUT.c usage_DOUT_Read  
*******************************************************************************/
...
* preferred DOUT_Read() API because the 
* DOUT_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet DOUT_SUT.c usage_DOUT_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: DOUT_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use DOUT_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - DOUT_0_INTR       (First pin in the list)
    *  - DOUT_1_INTR       (Second pin in the list)
    *  - ...
    *  - DOUT_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet DOUT_SUT.c usage_DOUT_SetInterruptMode
    *******************************************************************************/
    void DOUT_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & DOUT_0_INTR) != 0u) 
		{ 
			 DOUT_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet DOUT_SUT.c usage_DOUT_ClearInterrupt
    *******************************************************************************/
