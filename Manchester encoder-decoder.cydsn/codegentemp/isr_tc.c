...
void isr_tc_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_tc__INTC_NUMBER] = address;
}
...
cyisraddress isr_tc_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_tc__INTC_NUMBER];
}
