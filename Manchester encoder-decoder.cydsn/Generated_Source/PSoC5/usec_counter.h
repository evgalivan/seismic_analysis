...
#define usec_counter_INIT_PERIOD_VALUE       1023u
#define usec_counter_INIT_COUNTER_VALUE      1023u
#if (usec_counter_UsingFixedFunction)
...
#define usec_counter_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << usec_counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)0u << usec_counter_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)1u << usec_counter_STATUS_CMP_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << usec_counter_STATUS_OVERFLOW_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << usec_counter_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT)))
#define usec_counter_DEFAULT_COMPARE_MODE    2u
