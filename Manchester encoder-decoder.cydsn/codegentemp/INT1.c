...
*
* \funcusage
*  \snippet INT1_SUT.c usage_INT1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet INT1_SUT.c usage_INT1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet INT1_SUT.c usage_INT1_Read  
*******************************************************************************/
...
* preferred INT1_Read() API because the 
* INT1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet INT1_SUT.c usage_INT1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: INT1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use INT1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - INT1_0_INTR       (First pin in the list)
    *  - INT1_1_INTR       (Second pin in the list)
    *  - ...
    *  - INT1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet INT1_SUT.c usage_INT1_SetInterruptMode
    *******************************************************************************/
    void INT1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & INT1_0_INTR) != 0u) 
		{ 
			 INT1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet INT1_SUT.c usage_INT1_ClearInterrupt
    *******************************************************************************/
