...
# Date: Tue, 18 Aug 2020 14:01:40 GMT
#set_units -time ns
...
create_generated_clock -name {SPI_ADC_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 9 19} [list [get_pins {ClockBlock/dclk_glb_2}]]
create_generated_clock -name {SPIM_MEMS_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 37 73} [list [get_pins {ClockBlock/dclk_glb_3}]]
